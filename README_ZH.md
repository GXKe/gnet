...
<a title="Doc for gnet" target="_blank" href="https://pkg.go.dev/github.com/winlin/gnet/v2#section-documentation"><img src="https://img.shields.io/badge/go.dev-doc-007d9c?style=flat-square&logo=read-the-docs" /></a>
...
```powershell
go get -u github.com/winlin/gnet/v2
```
